import { SlashOption } from "../struct/commands/Command.ts";
...
/**
 * Represents an error for Citrus.
 */
export default class CitrusError<K extends keyof typeof Messages> extends Error {
	/**
	 * The error code.
	 */
