...
import CommandHandler, { ParsedComponentData } from "./CommandHandler.ts";

/**
 * Command utilities.
 */
export default class CommandUtil<MessageType extends CitrusMessage | Message> {
	/**
	...
	public constructor(handler: CommandHandler | ContextMenuCommandHandler, message: MessageType) {
		...
		this.isSlash = this.message instanceof CitrusMessage;
	}
	 ...
	 */
	public isSlashMessage(message: Message | CitrusMessage): message is CitrusMessage {
		return message instanceof CitrusMessage;
	}
